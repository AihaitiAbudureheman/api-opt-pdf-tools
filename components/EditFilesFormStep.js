      ...
      <form onSubmit={handlePreventDefault} ref={formRef}>
        ...
        >
          ...
          <div className={`${styles.previewer} w-100`}>
            <div
              className={`${isPanelTopSticky ? styles.panel_sticky : styles.panel
                } ${styles.panel_top} `}
            >
              <div
            ...
            <div
              className={`${isPanelBottomSticky ? styles.panel_sticky : styles.panel
                } ${styles.panel_bottom} `}
            >
              <div
              ...
              >
                {isFilesSelectionActive && (
                  ...
                  >
                    ...
                    {t("common:selected")}
                    {" "}
                    <span className={`${styles.select_info}`}>{t("common:selected_hold")}</span>{" "}
                    <span className={`${styles.select_info} fw-bold`}>{t("common:selected_ctrl")}</span>{" "}
                    <span className={`${styles.select_info}`}>{t("common:selected_onWindows")}</span>{", "}
                    <span className={`${styles.select_info} fw-bold`}>{t("common:selected_cmd")}</span>{" "}
                    <span className={`${styles.select_info}`}>{t("common:selected_onMac")}</span>
                  </div>
                )}
