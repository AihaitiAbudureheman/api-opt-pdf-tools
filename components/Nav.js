...
import { List, ChevronDown, X, ChevronUp,ArrowUpRightSquareFill } from "react-bootstrap-icons";
        ...
        <div>
          <nav className={`${styles.navigation}`}>
            <Link href="/" className={`${styles.logo}`}>
              <h3>
                <span className={`${styles.logo_info_left}`}>PDF</span>
                <span className={`${styles.logo_info_right}`}></span>
              </h3>
              <span className={`${styles.logo_info_by}`}>BY </span>
              <button className={`${styles.logo_info_goto}`} onClick={handleButtonClick}>Online Prime Tools <ArrowUpRightSquareFill/></button>
            </Link>
            <ul
              ref={navMenuRef}
