  ...
  if (contentType && contentType.indexOf("multipart/form-data") !== -1) {
    ...
    if (!result.files || !result.fields) {
      ...
      if (result.files.file && result.files.file.newFilename) {
        ...
        let file = await filesRepo.saveDataToJsonForImages(id, filepath);
        ...
        if (file != null) {
          ...
          if (originalFileData) {
            ...
            if (selectedIndexesArray === "") {
              ...
              -sDEVICE=bmp16m -r150 -dTextAlphaBits=4 -dGraphicsAlphaBits=4\
              -sOutputFile="${file.extractedImagesPath}/Page-%d.bmp" -f ${file.inputFilePath}`;
            } else {
